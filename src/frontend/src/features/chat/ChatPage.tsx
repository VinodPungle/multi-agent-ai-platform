...
export function ChatPage() {
  const { messages, conversationId, isStreaming, error, send, stop, regenerate, clear } = useChat();
  ...
  return (
    <div className="flex h-[calc(100dvh-8rem)] flex-col gap-4">
      ...
      <ChatComposer onSend={(text) => void send(text)} onStop={stop} isStreaming={isStreaming} />
